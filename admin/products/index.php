                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>10</td>
                                            <td>
                                                <a href="./update.php?id=1" class="btn btn-primary"><i
                                                        class="fa-solid fa-pencil"></i></a>
                                                <a href="./delete.php?id=1" class="btn btn-danger"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>20</td>
                                            <td>
                                                <a href="./update.php?id=2" class="btn btn-primary"><i
                                                        class="fa-solid fa-pencil"></i></a>
                                                <a href="./delete.php?id=2" class="btn btn-danger"><i
                                                        class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
